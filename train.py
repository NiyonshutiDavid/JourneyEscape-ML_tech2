...
try:
    ...
    # keep this try/except to surface issues early
    pass
...
def train_agent(
    ...
    # run final evaluation (use a fresh non-vectorized env wrapped by Monitor)
...
if __name__ == "__main__":
    main()
# filepath: /Users/blueclover/Desktop/JourneyEscape-ML_tech2/train.py
#!/usr/bin/env python3
"""
DQN Training Script for JourneyEscape Atari Environment
======================================================
